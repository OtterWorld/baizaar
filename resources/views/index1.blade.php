...
@section('content')
  <section class="main-banner" id="main-banner">
    ...
    <div class="main-banner__owl owl-carousel owl-theme">
      ...
      <!-- slide 1 -->
      <div class="main-banner__slide" style="background-image: url({{asset('assets/images/banner.jpg')}});">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 wow fadeInLeft">
              <div class="logo-flag">
                <img src="{{asset('assets/images/baizaar-flag.png')}}" alt="baizaar">
              </div>
  ...
  <section class="floor-map">
    ...
    <div class="autopsy-floor-map">
      <a href="#floor-map__wrap">
        <img src="{{asset('assets/images/location.png')}}" alt="Закрыть карту этажей">
        Закрыть карту этажей
      </a>
    </div>

    <div class="container">

      <div class="floor-map__wrap" id="floor-map__wrap">
        ...
        <div class="row">
                ...
                <div class="floor-map-tabs__accordion wow" id="parking">
                  <ul>
                    <li>
                      <a href="#">
                        Развлечение0
                        <span class="accordion__arrow"><img src="{{asset('assets/images/map-accordeon-arrow-down.png')}}" alt="icon"></span>
                      </a>
          ...
          <div class="col-lg-8 col-md-8 col-sm-12" data-aos="fade-left">
            <div class="floor-map__right">
              <img src="{{asset('assets/images/map-floor.png')}}" alt="">
  ...
  <section class="discounts">
    ...
    <div class="discount-slide__owl owl-carousel owl-theme wow fadeInUp">
      ...
      <div class="discount-slide__wrap">
        ...
        <div class="discount-slide__item" style="background-image: url({{asset('assets/images/discount-1.jpg')}});">
      ...
      <div class="discount-slide__wrap">
        ...
        <div class="discount-slide__item" style="background-image: url({{asset('assets/images/discount-2.jpg')}});">
          <div class="discount-percent">
            Скидка <span class="percent__item">-25%</span>
          </div>
      ...
      <div class="discount-slide__wrap">
        ...
        <div class="discount-slide__item" style="background-image: url({{asset('assets/images/discount-3.jpg')}});">
          <div class="discount-percent">
            Скидка <span class="percent__item">-25%</span>
          </div>
      ...
      <div class="development-slide__wrap wow fadeInUp">
        ...
        <div class="developments-slide owl-carousel owl-theme">
          ...
          <div class="developments-slide__item">
            ...
            <div class="developments-slide__top" style="background-image: url({{ Voyager::image($news[$i]->image) }});">
              <div class="developments-percent">
                {{$news[$i]->month}} <span class="percent__item">{{$news[$i]->day}}</span>
              </div>
            </div>
    
            <div class="developments-slide__bottom hvr-shutter-out-horizontal">
              <p class="developments-slide__text">{{$news[$i]->description}}</p>

              <a href="news/{{$news[$i]->id}}/{{$news[$i]->id}}" class="developments-slide__btn">Подробнее...</a>
            </div>
  ...
  <section class="about-baizar">
    ...
    <div class="about-baizar__wrap" style="background-image: url({{asset('assets/images/about-bg.jpg')}})">
